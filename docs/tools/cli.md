...
**Source Code:** The CLI source code is available on [Github](https://github.com/notifoxhq/notifox-cli)!
      ...
      - name: Notify on failure
        ...
        run: |
          ...
          printf '%s\n' \
            ...
            "Link: $RUN_URL" | notifox send -a joe -c sms 
```
...
spec:
  template:
    spec:
      containers:
      - name: checker
        image: your-image # with the notifox-cli installed (otherwise you can install it inline)
        command:
        - /bin/sh
        - -c
        - |
...
- **GitHub Repository:** [https://github.com/notifoxhq/notifox-cli](https://github.com/notifoxhq/notifox-cli) - Source code, issues, and releases
- **Notifox Documentation:** [https://docs.notifox.com](https://docs.notifox.com) - Complete API and SDK documentation
- **Notifox Go SDK:** [https://github.com/notifoxhq/notifox-go](https://github.com/notifoxhq/notifox-go) - Go SDK for Notifox
